...
To learn more about this project, you can view the research paper <script language='JavaScript'>
document.write('<a href=st.marie.thesis.final.pdf target=_blank>');
document.write('here' + '</a>');
</script>. If you'd like to arrange a test of the system or have any questions, please email <script language='JavaScript'>
document.write('<a href=\"mailto:' + 'brsm' + '@' + 'alumni.harvard.edu' + '\">');
document.write('brsm' + '@' + 'alumni.harvard.edu' + '</a>');
</script>."
