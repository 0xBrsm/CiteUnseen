...
public class BingWebSearch extends SearchEngine {
	// The common name for this search engine
	private static final String NAME = "BingWeb";
	...
	private  Map<String, String> setElements () {
		...
		elements.put("parentContainer",			"{\"d\": }");
	...
	@Override
 	protected Map<String, String> buildQuery (String query, int id) {	
		...
		String searchURL = "https://api.datamarket.azure.com/Bing/SearchWeb/Web?$format=json&Query="+encodedQuery;		
